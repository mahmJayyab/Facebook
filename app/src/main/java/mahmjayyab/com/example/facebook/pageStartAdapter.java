...
public class pageStartAdapter extends RecyclerView.Adapter<pageStartAdapter.ViewHolder> {
    ...
    public pageStartAdapter(List<Pages> Pages, Context mContext) {
        this.pages = Pages;
    ...
    @Override
    public pageStartAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.page_start_item, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            supscripeBtn = (CheckBox) v.findViewById(R.id.checkToSup);
